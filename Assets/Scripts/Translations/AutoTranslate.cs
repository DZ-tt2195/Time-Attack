...
public static string Resupply_Text (string Num) => Translator.inst.Translate("Resupply_Text", new() {("Num", Num)});
...
public static string Walls () => Translator.inst.Translate("Walls", new() {});
public static string Walls_Text (string Num) => Translator.inst.Translate("Walls_Text", new() {("Num", Num)});
public static string Bomb () => Translator.inst.Translate("Bomb", new() {});
public static string Bomb_Text (string Num) => Translator.inst.Translate("Bomb_Text", new() {("Num", Num)});
...
public static string Jammed () => Translator.inst.Translate("Jammed", new() {});
public static string Jammed_Text (string Num) => Translator.inst.Translate("Jammed_Text", new() {("Num", Num)});
public static string Necromancy () => Translator.inst.Translate("Necromancy", new() {});
public static string Necromancy_Text (string Num) => Translator.inst.Translate("Necromancy_Text", new() {("Num", Num)});
public static string Flag () => Translator.inst.Translate("Flag", new() {});
public static string Flag_Text (string Num) => Translator.inst.Translate("Flag_Text", new() {("Num", Num)});
public static string Home () => Translator.inst.Translate("Home", new() {});
public static string Home_Text (string Num) => Translator.inst.Translate("Home_Text", new() {("Num", Num)});
