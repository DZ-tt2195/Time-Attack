...
public static string Freeze_Text () => Translator.inst.Translate("Freeze_Text", new() {});
public static string Warp () => Translator.inst.Translate("Warp", new() {});
public static string Warp_Text () => Translator.inst.Translate("Warp_Text", new() {});
public static string Barriers () => Translator.inst.Translate("Barriers", new() {});
public static string Barriers_Text () => Translator.inst.Translate("Barriers_Text", new() {});
public static string Burn () => Translator.inst.Translate("Burn", new() {});
public static string Burn_Text () => Translator.inst.Translate("Burn_Text", new() {});
