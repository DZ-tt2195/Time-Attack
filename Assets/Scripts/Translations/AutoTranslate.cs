...
public static string Checkpoint () => Translator.inst.Translate("Checkpoint", new() {});
public static string Checkpoint_Text (string Num) => Translator.inst.Translate("Checkpoint_Text", new() {("Num", Num)});
